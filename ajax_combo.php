	...
	$lookups = array(   
		'equipos' => array(   
			'articulo' => array(
				...
				'parent_pk_field' => 'id',
				'parent_caption' => '`articulos`.`articulo`',
				'parent_from' => '`articulos` ',
				'filterers' => array(),
				'custom_query' => '',
			...
			'modelo' => array(
				'parent_table' => 'modelos',
				'parent_pk_field' => 'id',
				'parent_caption' => '`modelos`.`modelo`',
				'parent_from' => '`modelos` LEFT JOIN `marcas` as marcas1 ON `marcas1`.`id`=`modelos`.`marca` ',
			...
			'familia' => array(
				'parent_table' => 'familias',
				'parent_pk_field' => 'id',
				'parent_caption' => '`familias`.`familia`',
				'parent_from' => '`familias` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
		...
		'equipo_repuestos' => array(   
			'interno' => array(
				'parent_table' => 'equipos',
				'parent_pk_field' => 'id',
				'parent_caption' => '`equipos`.`interno`',
				'parent_from' => '`equipos` LEFT JOIN `articulos` as articulos1 ON `articulos1`.`id`=`equipos`.`articulo` LEFT JOIN `marcas` as marcas1 ON `marcas1`.`id`=`equipos`.`marca` LEFT JOIN `modelos` as modelos1 ON `modelos1`.`id`=`equipos`.`modelo` LEFT JOIN `familias` as familias1 ON `familias1`.`id`=`equipos`.`familia` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
			...
			'codigo' => array(
				'parent_table' => 'repuestos',
				'parent_pk_field' => 'id',
				'parent_caption' => '`repuestos`.`codigo`',
				'parent_from' => '`repuestos` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
			...
			'descripcion' => array(
				'parent_table' => 'repuestos',
				'parent_pk_field' => 'id',
				'parent_caption' => '`repuestos`.`descripcion`',
				'parent_from' => '`repuestos` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
		...
		'planificaciones' => array(   
			'tecnico' => array(
				'parent_table' => 'tecnicos',
				'parent_pk_field' => 'id',
				'parent_caption' => '`tecnicos`.`nombre`',
				'parent_from' => '`tecnicos` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
			...
			'camioneta' => array(
				'parent_table' => 'camionetas',
				'parent_pk_field' => 'id',
				'parent_caption' => 'IF(CHAR_LENGTH(`camionetas`.`interno`) || CHAR_LENGTH(`camionetas`.`matricula`), CONCAT_WS(\'\', `camionetas`.`interno`, \' - \', `camionetas`.`matricula`), \'\')',
				'parent_from' => '`camionetas` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
		...
		'planificacion_equipos' => array(   
			'planificacion' => array(
				'parent_table' => 'planificaciones',
				'parent_pk_field' => 'id',
				'parent_caption' => '`planificaciones`.`titulo`',
				'parent_from' => '`planificaciones` LEFT JOIN `tecnicos` as tecnicos1 ON `tecnicos1`.`id`=`planificaciones`.`tecnico` LEFT JOIN `camionetas` as camionetas1 ON `camionetas1`.`id`=`planificaciones`.`camioneta` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
			...
			'cliente' => array(
				...
				'parent_pk_field' => 'id',
				'parent_caption' => '`clientes`.`nombre`',
				'parent_from' => '`clientes` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
			...
			'modelo' => array(
				'parent_table' => 'equipos',
				'parent_pk_field' => 'id',
				'parent_caption' => 'IF(    CHAR_LENGTH(`modelos1`.`modelo`), CONCAT_WS(\'\',   `modelos1`.`modelo`), \'\')',
				'parent_from' => '`equipos` LEFT JOIN `articulos` as articulos1 ON `articulos1`.`id`=`equipos`.`articulo` LEFT JOIN `marcas` as marcas1 ON `marcas1`.`id`=`equipos`.`marca` LEFT JOIN `modelos` as modelos1 ON `modelos1`.`id`=`equipos`.`modelo` LEFT JOIN `familias` as familias1 ON `familias1`.`id`=`equipos`.`familia` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
