<?php
	...
	if($thisMD5==$prevMD5){
		...
		setupTable('repuestos', "create table if not exists `repuestos` (   `id` INT unsigned not null auto_increment , primary key (`id`), `codigo` VARCHAR(40) null , `descripcion` VARCHAR(40) null ) CHARSET utf8", $silent);
		...
		setupTable('planificacion_equipos', "create table if not exists `planificacion_equipos` (   `id` INT unsigned not null auto_increment , primary key (`id`), `planificacion` INT unsigned null , `cliente` INT unsigned null , `equipo` INT unsigned null , `modelo` INT unsigned null , `ubicacion` VARCHAR(40) null , `horometro` VARCHAR(40) null , `cumplido` INT null default '0' , `comentarios` VARCHAR(40) null , `fecha_cumplido` DATE null , `distancia` VARCHAR(40) null ) CHARSET utf8", $silent);
		setupIndexes('planificacion_equipos', array('planificacion','cliente','equipo'));
		...
		setupTable('planificacion_pendientes', "create table if not exists `planificacion_pendientes` (   `id` INT unsigned not null auto_increment , primary key (`id`), `planificacion` INT unsigned null , `interno` INT unsigned null , `comentario` VARCHAR(40) null ) CHARSET utf8", $silent);
