<?php
	...
	*/
	...
	$schema = array(   
		...
		'modelos' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'modelo' => array('appgini' => 'VARCHAR(40) null '),
			'marca' => array('appgini' => 'INT unsigned null ')
		),
		'familias' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'familia' => array('appgini' => 'VARCHAR(40) null ')
		),
		'repuestos' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
		...
		'articulos' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'articulo' => array('appgini' => 'VARCHAR(40) null ')
		),
		'marcas' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'marca' => array('appgini' => 'VARCHAR(40) null ')
		),
		...
		'tecnicos' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'nombre' => array('appgini' => 'VARCHAR(40) null ')
		),
		'planificaciones' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'titulo' => array('appgini' => 'VARCHAR(40) null '),
			'tecnico' => array('appgini' => 'INT unsigned null '),
			'camioneta' => array('appgini' => 'INT unsigned null '),
			'fecha_planificado' => array('appgini' => 'DATE null ')
		),
		...
		'codigo_servicios' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'servicio' => array('appgini' => 'VARCHAR(40) null ')
		),
		'camionetas' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'interno' => array('appgini' => 'VARCHAR(40) null '),
			'matricula' => array('appgini' => 'VARCHAR(40) null ')
		),
		'clientes' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'nombre' => array('appgini' => 'VARCHAR(40) null ')
