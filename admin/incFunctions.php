		...
		$all_tables = array(
			/* ['table_name' => [table props assoc array] */   
				...
				'familias' => array(
					'Caption' => 'Familias',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/teddy_bear.png',
					'group' => $tg[1],
					'homepageShowCount' => 0
				),
				'repuestos' => array(
					'Caption' => 'Repuestos',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/cog.png',
					'group' => $tg[1],
					'homepageShowCount' => 0
				),
				'articulos' => array(
				...
				'tecnicos' => array(
					'Caption' => 'Tecnicos',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/role.png',
					'group' => $tg[1],
					'homepageShowCount' => 0
				),
				...
				'planificacion_pendientes' => array(
					'Caption' => 'Planificacion pendientes',
					'Description' => '',
					'tableIcon' => 'table.gif',
					'group' => $tg[0],
					'homepageShowCount' => 0
	...
	if(!function_exists('getTableList')){
		function getTableList($skip_authentication = false){
			$arrTables = array(   
				...
				'articulos' => 'Articulos',
				'marcas' => 'Marcas',
				'equipo_repuestos' => 'Equipo repuestos',
				'tecnicos' => 'Tecnicos',
				'planificaciones' => 'Planificaciones',
				'planificacion_equipos' => 'Planificacion equipos',
				'codigo_servicios' => 'Codigo servicios',
				'camionetas' => 'Camionetas',
				'clientes' => 'Clientes',
				'planificacion_pendientes' => 'Planificacion pendientes'
			);
