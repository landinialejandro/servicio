...
function equipos_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function modelos_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function familias_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function repuestos_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
...
function marcas_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function equipo_repuestos_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function tecnicos_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function planificaciones_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function planificacion_equipos_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function codigo_servicios_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function camionetas_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function clientes_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function planificacion_pendientes_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
...
function persist_expanded_child(id){
	var expand_these = JSON.parse(localStorage.getItem('servicio.dvp_expand'));
	...
	if($j('[id=' + id + ']').hasClass('active')){
		if(expand_these.indexOf(id) < 0){
			...
			localStorage.setItem('servicio.dvp_expand', JSON.stringify(expand_these));
		}
	}else{
		if(expand_these.indexOf(id) >= 0){
